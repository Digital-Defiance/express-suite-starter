...
describe('ProjectGenerator', () => {
  const mockRunCommand = shellUtils.runCommand as jest.MockedFunction<typeof shellUtils.runCommand>;
  ...
  describe('generateReact', () => {
    it('generates React application with correct parameters', () => {
      const config = { type: 'react' as const, name: 'my-react', importPath: '@test/react', enabled: true };
  ...
  describe('generateReactLib', () => {
    it('generates React library with correct parameters', () => {
      const config = { type: 'react-lib' as const, name: 'my-react-lib', importPath: '@test/react-lib', enabled: true };
  ...
  describe('generateApi', () => {
    it('generates API application with Express framework', () => {
      const config = { type: 'api' as const, name: 'my-api', importPath: '@test/api', enabled: true };
  ...
  describe('generateApiLib', () => {
    it('generates API library with no bundler', () => {
      const config = { type: 'api-lib' as const, name: 'my-api-lib', importPath: '@test/api-lib', enabled: true };
  ...
  describe('generateLib', () => {
    it('generates shared library', () => {
      const config = { type: 'lib' as const, name: 'my-lib', importPath: '@test/lib', enabled: true };
  ...
  describe('generateInitUserDb', () => {
    it('generates inituserdb with no framework', () => {
      const config = { type: 'inituserdb' as const, name: 'my-inituserdb', importPath: '@test/inituserdb', enabled: true };
  ...
  describe('generateTestUtils', () => {
    it('generates test-utils library', () => {
      const config = { type: 'test-utils' as const, name: 'my-test-utils', importPath: '@test/test-utils', enabled: true };
