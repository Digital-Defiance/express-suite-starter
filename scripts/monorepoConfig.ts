...
export const addScripts: Record<string, string> = {
  ...
  "serve": `NX_TUI=false NX_NATIVE_COMMAND_RUNNER=false npx nx serve \${apiAppName} --configuration production`,
  "serve:dev": `NX_TUI=false NX_NATIVE_COMMAND_RUNNER=false npx nx serve \${apiAppName} --configuration development`,
