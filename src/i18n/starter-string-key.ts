export enum StarterStringKey {
  ...
  // Translation
  PROMPT_AUTO_TRANSLATE = 'prompt_autoTranslate',
  TRANSLATION_PROVIDER_GOOGLE_FREE = 'translation_providerGoogleFree',
  TRANSLATION_PROVIDER_AWS = 'translation_providerAws',
  TRANSLATION_PROVIDER_AWS_ENTER_CREDS = 'translation_providerAwsEnterCreds',
  TRANSLATION_PROVIDER_SKIP = 'translation_providerSkip',
  TRANSLATION_TRANSLATING = 'translation_translating',
  TRANSLATION_SUCCESS = 'translation_success',
  TRANSLATION_PARTIAL_FAILURE = 'translation_partialFailure',
  TRANSLATION_FAILED_TRYING_NEXT = 'translation_failedTryingNext',
  TRANSLATION_FAILED_FALLBACK = 'translation_failedFallback',
  TRANSLATION_SKIPPED = 'translation_skipped',
  PROMPT_AWS_REGION = 'prompt_awsRegion',
  PROMPT_AWS_ACCESS_KEY_ID = 'prompt_awsAccessKeyId',
  PROMPT_AWS_SECRET_ACCESS_KEY = 'prompt_awsSecretAccessKey',
  PROMPT_TRY_AWS_TRANSLATE = 'prompt_tryAwsTranslate',
  NOTICE_TRANSLATIONS_AUTO_GENERATED = 'notice_translationsAutoGenerated',
  WARNING_TRANSLATE_TODO_LANGUAGES = 'warning_translateTodoLanguages',
}
