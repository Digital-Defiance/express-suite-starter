...
export const zhCnTranslations: Record<StarterStringKey, string> = {
  ...
  [StarterStringKey.STEP_UPDATE_TSCONFIG_BASE]: '正在更新 TypeScript 基础配置',
  ...
  [StarterStringKey.PACKAGE_RESOLUTIONS_ADDED]: '已为 @noble/curves、@noble/hashes、@scure/bip32、@scure/bip39 和 @ethereumjs/wallet 添加包解决方案',
