...
export const enUsTranslations: Record<StarterStringKey, string> = {
  ...
  [StarterStringKey.STARTER_DESCRIPTION]:
    'Node Express Suite Starter generates an NX monorepo MERN stack with React app, Express API, shared libraries, @digitaldefiance/node-express-suite, and @digitaldefiance/express-suite-react-components integration.',
  ...
  [StarterStringKey.CLI_CANCELLED]:
    'Cancelled. Please install required tools and try again.',
  ...
  [StarterStringKey.PROMPT_HOSTNAME]:
    'Enter the hostname that will be used for production:',
  ...
  [StarterStringKey.PROMPT_ENABLE_DOC_GENERATION]:
    'Generate documentation (README, ARCHITECTURE, API docs)?',
  ...
  [StarterStringKey.VALIDATION_INVALID_NAMESPACE]:
    'Invalid namespace (must start with @)',
  ...
  [StarterStringKey.VALIDATION_REACT_VERSION_MISMATCH]:
    'React version mismatch with @types/react',
  [StarterStringKey.VALIDATION_REACT_DOM_REQUIRED]:
    'react-dom is required when using react',
  ...
  [StarterStringKey.PACKAGE_RESOLUTIONS_ADDED]:
    'Added package resolutions for @noble/curves, @noble/hashes, @scure/bip32, @scure/bip39, and @ethereumjs/wallet',

  // Environment Setup
  [StarterStringKey.ENV_CREATED_WITH_SECRETS]:
    'Created {name}/.env with secrets',
  [StarterStringKey.ENV_CREATED_FROM_API]:
    'Created {name}/.env from {apiName}/.env',
  [StarterStringKey.ENV_CREATED_DEVCONTAINER]:
    'Created .devcontainer/.env with MongoDB configuration',
  [StarterStringKey.ENV_CREATED_DEVCONTAINER_FROM_EXAMPLE]:
    'Created .devcontainer/.env from .env.example with MongoDB configuration',
  [StarterStringKey.ENV_CREATED_DEVCONTAINER_MINIMAL]:
    'Created minimal .devcontainer/.env (no .env.example found)',
  ...
  [StarterStringKey.PACKAGE_INSTALL_BUILD_TOOLS]:
    'If you see "exit code 127" above, install build tools:',
  ...
  [StarterStringKey.PACKAGE_RESOLVING_VERSION]:
    'Resolving version for {package}',
  [StarterStringKey.PACKAGE_FAILED_RESOLVE_LATEST]:
    "Failed to resolve latest version for {package}, using 'latest'",
  [StarterStringKey.PACKAGE_FAILED_RESOLVE_STABLE]:
    "Failed to resolve stable version for {package}, using 'latest'",

  // Plugin System
  [StarterStringKey.PLUGIN_REGISTERING]:
    'Registering plugin: {name} v{version}',
  [StarterStringKey.PLUGIN_HOOK_FAILED]:
    'Plugin {name} hook {hook} failed: {error}',
  ...
  [StarterStringKey.COMMAND_REBUILDING_NATIVE]:
    'Re-enabling build scripts and building native modules...',
  ...
  [StarterStringKey.COMMAND_SKIPPED_PLAYWRIGHT]:
    'Skipped. Run manually later: yarn playwright install --with-deps',
  ...
  [StarterStringKey.WARNING_UPDATE_ENV_FILE]:
    'IMPORTANT: Update {name}/.env with your configuration',
  [StarterStringKey.WARNING_UPDATE_DEVCONTAINER_ENV]:
    'IMPORTANT: Update .devcontainer/.env with your MongoDB configuration',
  [StarterStringKey.WARNING_VALIDATION_ERRORS]:
    'Validation found errors, but continuing...',
  [StarterStringKey.WARNING_DRY_RUN_RERUN]:
    'Dry-run complete. Re-run without dry-run to generate.',

  // Notice Messages
  [StarterStringKey.NOTICE_SITE_TITLE_TAGLINE_DESCRIPTIONS]:
    'Generic default Site Title, Tagline, and Descriptions have been filled in for the other languages. Edit the i18n-setup.ts file to customize these values.',
  ...
  [StarterStringKey.SECTION_NEXT_STEPS_UPDATE_ENV]:
    '# Update {name}/.env with your settings',
  [StarterStringKey.SECTION_NEXT_STEPS_INIT_DB]: 'yarn inituserdb',
  [StarterStringKey.SECTION_NEXT_STEPS_COPY_CREDENTIALS]:
    '⚠️  Copy the credentials block from the output above to {name}/.env\n      The credentials include ADMIN_ID, ADMIN_MNEMONIC, ADMIN_PASSWORD, etc.',
  [StarterStringKey.SECTION_NEXT_STEPS_MEMORY_DB_INFO]:
    'ℹ️  Using in-memory database - user credentials will be auto-generated at runtime',
